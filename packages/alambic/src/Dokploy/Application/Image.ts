...
export type ApplicationImage = Resource<
  "Alambic.Dokploy.Application.Image",
...
export const ApplicationImage = Resource<ApplicationImage>("Alambic.Dokploy.Application.Image");
      ...
      reconcile: Effect.fn(function* ({ id, news, output }) {
        if (!news || !isResolved(news)) {
          return yield* Effect.die(
            new Error("Alambic.Dokploy.Application.Image: unresolved props at reconcile"),
          );
        }
        ...
        try {
          ...
          return yield* Effect.die(
            e instanceof Error
              ? e
              : new Error("Alambic.Dokploy.Application.Image: invalid image props"),
          );
        }
